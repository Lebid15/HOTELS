...
from .views import (
    ...
    HotelViewSet, HotelSettingsView, ShiftReportView, HotelDuesView, PackageViewSet,
...
urlpatterns = [
    ...
    # م8: مستحقات المنصّة كما يراها مدير الفندق
    path('hotel-dues/', HotelDuesView.as_view(), name='hotel-dues'),
