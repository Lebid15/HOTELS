    ...
    <main className="min-h-screen bg-slate-50 text-slate-900" dir="rtl">
      <nav className="flex items-center justify-between border-b border-slate-200 bg-white px-8 py-4 shadow-sm">
        <div>
          ...
          <h1 className="text-lg font-semibold text-slate-800">لوحة مدير الفندق</h1>
        </div>
      ...
      <div className="mx-auto max-w-6xl px-8 py-12">
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-3">
          {[
            { label: "الغرف المتاحة", value: "—" },
            { label: "الحجوزات اليوم", value: "—" },
        ...
        <div className="mt-10 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
          <p className="text-slate-500 text-sm">
            هذه لوحة مدير الفندق — ستظهر هنا إدارة الغرف والموظفين والحجوزات.
          </p>
        </div>
      </div>
    </main>
